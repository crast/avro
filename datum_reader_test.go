...
func BenchmarkSpecificDatumReader_complex_orig(b *testing.B) {
	findField = findFieldOrig
	var dest complex
	specificReaderBenchComplex(b, &dest)
}

func BenchmarkSpecificDatumReader_complex_newFindField(b *testing.B) {
	findField = findFieldNew
	var dest complex
	specificReaderBenchComplex(b, &dest)
}
...
func BenchmarkSpecificDatumReader_hugeval_orig(b *testing.B) {
	findField = findFieldOrig
	var dest hugeval
	specificReaderBenchComplex(b, &dest)
}

func BenchmarkSpecificDatumReader_hugeval_newFindField(b *testing.B) {
	findField = findFieldNew
	var dest hugeval
	specificReaderBenchComplex(b, &dest)
}
